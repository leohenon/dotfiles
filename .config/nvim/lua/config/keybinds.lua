...
map("x", "p", '"_d"+P', { desc = "Paste from system clipboard (selection discarded)" })
map("n", "P", '"+P', { desc = "Paste above from system clipboard" })

map({ "n", "x" }, "<leader>y", '""y', { desc = "Yank to vim register" })
map("n", "<leader>yy", '""yy', { desc = "Yank line to vim register" })
map("n", "<leader>p", '""p', { desc = "Paste from vim register" })
map("x", "<leader>p", '"_d""P', { desc = "Paste from vim register (selection discarded)" })
map("n", "<leader>P", '""P', { desc = "Paste above from vim register" })
